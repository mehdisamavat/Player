 ...
 */
fun MediaMetadataCompat.Builder.from(post:Post): MediaMetadataCompat.Builder {
    // The duration from the JSON is given in seconds, but the rest of the code works in
    // milliseconds. Here's where we convert to the proper units.
//    val durationMs = TimeUnit.SECONDS.toMillis(post.duration)
...
//    duration = durationMs
    genre = ""
    mediaUri = post.source
    albumArtUri = post.image
//    trackNumber = ""
//    trackCount = ""
    ...
    displaySubtitle = post.artist
//    displayDescription = post.album
    displayIconUri = post.image
